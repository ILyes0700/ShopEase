...
$req4 = mysqli_query($conn, "SELECT id FROM entreprise WHERE tel = '$tel' LIMIT 1");
if (mysqli_num_rows($req4) > 0) {
    ...
    require 'vendor/autoload.php'; // Charge PHPMailer
                ...
                try {
                    ...
                    $mail->AddEmbeddedImage('logtest.webp', 'logo');  // 'logo' est le cid de l'image attachée
                    ...
                    <body>
                        <div class='container'>
                            ...
                            <p>Si vous n'avez pas demandé ce rappel, nous vous recommandons de sécuriser votre compte immédiatement en changeant votre ID.</p>
