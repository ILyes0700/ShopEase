...
$req4 = mysqli_query($conn, "SELECT passworde FROM passient WHERE tel = '$tel' LIMIT 1");
if (mysqli_num_rows($req4) > 0) {
    $row = mysqli_fetch_assoc($req4);
    $id_entreprise = $row['passworde'];
    ...
    <head>
        ...
        <style>
            ...
            .info {
                ...
                padding: 10px;
                border-left: 4px solid rgb(134, 112, 156);
                margin-top: 20px;
                font-size: 16px;
            }
            .footer {
    ...
    <body>
        ...
        <div class='logo'>
            ...
            <h2>Bonjour,</h2>
            <p>Vous avez demandé un rappel de votre Mot de Passe  pour votre compte sur <strong>ShopEase</strong>.</p>
            
            <div class='info'>
                <strong>Votre Mot de Passe actuel :</strong> $id_entreprise
            
            <p>Si vous n'avez pas demandé ce rappel, nous vous recommandons de sécuriser votre compte immédiatement en changeant Mot de Passe .</p>
...
";
                    ...
                    $mail->AltBody = 'Bonjour , Votre inscription en tant que Livraison est confirmée. Telephone : ' . $tel;
